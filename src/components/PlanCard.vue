    ...
    <div class="flex items-center -mx-4">
      ...
      <div class="w-3/5 px-4">
        <ul class="list-reset text-sm text-navy-lighter font-medium -mb-1">
          <li v-for="(feature, i) in features" v-bind:key="i" class="mb-1">{{ feature }}</li>
        </ul>
      </div>
    </div>
  </button>
